...
def main():
    ...
    ap.add_argument('rom')
    ap.add_argument('out')
    ap.add_argument('--map', default='ド=초',
                    help='쉼표로 구분한 "일본어=한글" 매핑 (기본: ド=초)')
